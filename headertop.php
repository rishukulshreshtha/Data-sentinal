...
<html class="no-js" lang="">
    <head>
		...
		<meta name="author" content="rishabh kulshreshtha">
...
s1.async=true;
s1.src='https://embed.tawk.to/6516685c10c0b2572486b208/1hbfofaur';
s1.charset='UTF-8';
        ...
        <header class="container header_area" >
			<div id="sticker">
				<div class="head">
					...
					<h2>kulshreshtha University Management System</h2>
					</div>
				</div>
				<div class="menu ">
